...
var basePalabras = ['alura','orange','bootcamp','profesores','alumnos','challenge','ahorcado'];
...
document.addEventListener("DOMContentLoaded", function () { 
 ...
 // iniciara el juego cuando se apriete el boton 
...
iniciarJuego.addEventListener("click", function (evt){
    ...
    document.getElementById("input-text").style.display = "none";// borrara la palabra
